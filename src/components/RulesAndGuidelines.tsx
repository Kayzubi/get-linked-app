        ...
        <div className=' max-w-7xl h-full mx-auto lg:grid grid-cols-2 w-full'>
          <div className=' pt-5 flex flex-col justify-center gap-9  text-white-100 text-center lg:text-left '>
            <div className=' relative'>
              <span className='star-sm after:bg-white-10 before:bg-white-10 top-0 right-[50%]'></span>
              <span className='star after:bg-white-100 before:bg-white-100 bottom-0 right-[10%]'></span>
              <motion.h1
